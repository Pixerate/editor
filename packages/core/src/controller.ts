...
export interface EditorControllerOptions extends Partial<
  Omit<EditorOptions, "element" | "content">
> {
...
export class EditorController {
  ...
  private readonly markdownMode: boolean;
  private readonly onPlainTextChange?: (text: string) => void;
  private readonly onMarkdownChange?: (markdown: string) => void;
  ...
  constructor(options: EditorControllerOptions = {}) {
    ...
    const initialContent =
      plainTextMode && typeof content === "string"
        ...
        : markdownMode && typeof content === "string"
          ? markdownToTipTapHtml(content)
          : content;
  ...
  private handleUpdate() {
    ...
    if (this.markdownMode || this.onMarkdownChange) {
